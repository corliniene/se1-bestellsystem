...
public final class Application_2 {
	...
	public static void main(String[] args) {
		...
		// Timo's order
		Order o7256 = dataFactory.createOrder(cTimo);
		o7256.addItem(													// 1x Kaffeemaschine
		...
		//Sandra's order
		Order o5478 = dataFactory.createOrder(cSandra);
		o5478.addItem(													// 1x Teekocher
		...
		List<Order> orders = new ArrayList<Order>( List.of( o5234, o8592, o3563, o6135, o7256, o5478 ) );
